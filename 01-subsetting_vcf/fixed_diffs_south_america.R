...
#Extract the name of the samples used for generating the vcf and separate them in Sb vs SB. Make sure to select only
#colonies from Argentina (where the populations from which RNAseq data was generated), labeled as AR.
...
writeVcf(fixed_diff_vcf, filename = "results/supergene_fixed_diffs_south_america.vcf")
