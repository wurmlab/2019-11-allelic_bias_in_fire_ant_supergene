...
#Output positions present in both files
bcftools isec -n =2 tmp/subset_north_america.vcf.gz tmp/subset_south_america.vcf.gz -o tmp/common_snps.vcf
#Number of variants in common between the two populations
wc -l tmp/common_snps.vcf
#2877, ~ 92% of the SNPs in South American

#Use SNPeff to detect the effect of SNPs in genes.
