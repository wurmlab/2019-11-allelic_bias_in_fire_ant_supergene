...
fill_colors <- c(rgb(228,26,28, maxColorValue = 255), rgb(55,126,184, maxColorValue = 255),
                 rgb(77,175,74, maxColorValue = 255), rgb(152,78,163, maxColorValue = 255),
                 rgb(255,127,0, maxColorValue = 255))
contour_colors <- c(rgb(160,18,18, maxColorValue = 255), rgb(39, 88, 129, maxColorValue = 255),
                 rgb(54, 122, 52, maxColorValue = 255), rgb(106, 55, 114, maxColorValue = 255),
...
#Generate plot
plot(euler_sig_genes, quantities = TRUE, edges = TRUE, labels = list(fontsize = 8))
## Save:
ggsave(plot = aver, filename = "results/euler_plot.pdf", width = 20, height = 20, units = "cm")
```
