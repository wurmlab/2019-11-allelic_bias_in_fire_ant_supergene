...
```{r plot_heatmap_ratio_north_america, include = FALSE}
#Parse the dataset to make it ggplot friendly
...
```{r plot_heatmap_ratio_north_america_genes_both, include = FALSE}
...
```{r plot_heatmap_ratio_south_america, include = FALSE}
...
```{r plot_heatmap_ratio_both, include = FALSE}
...
```{r plot_heatmap_read_counts_compare_populations, include = FALSE}
#Ensure the datasets for both populations have the same genes. 
...
For South America
```{r plot_heatmap_read_counts_south_america, include = FALSE}
