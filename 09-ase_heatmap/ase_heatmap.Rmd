...
knitr::opts_chunk$set(echo = TRUE)#, fig.path = 'results/', fig.width = 60, fig.height = 30)
```
...
parsed_counts_all_ratios_common_genes$gene[parsed_counts_all_ratios_common_genes$gene %in% sig_genes_both] <- paste0(parsed_counts_all_ratios_common_genes$gene[parsed_counts_all_ratios_common_genes$gene %in% sig_genes_both], "*+")
...
gene_positions_min$gene[gene_positions_min$gene %in% sig_genes_both] <- paste0(gene_positions_min$gene[gene_positions_min$gene %in% sig_genes_both], "*+")
